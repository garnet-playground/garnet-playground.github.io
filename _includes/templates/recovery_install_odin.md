...
2. Download [Lineage Recovery](https://garnet-playground.github.io/devices/{{ custom_recovery_codename }}). Simply download the latest recovery file, named `{{ device.recovery_partition_name }}.img`
