...
1. Download the [LineageOS zip file](https://garnet-playground.github.io/devices/{{ device.codename }}) that you would like to install or [build]({{ device | device_link: "/build" | relative_url }}) the package yourself.
{%- else %}
